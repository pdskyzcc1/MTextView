 ...
 * @下午5:29:27
 */
public class AntiNewLineTextView extends TextView {

    private static final String TAG = "AntiNewLineTextView";
    ...
    public AntiNewLineTextView(Context context, AttributeSet attrs, int defStyle) {
